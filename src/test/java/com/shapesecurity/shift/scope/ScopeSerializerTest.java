...
public class ScopeSerializerTest {
  ...
  public void testScopeSerializer_variableDeclaration1() throws JsError {
    ...
    // check serialization
    TestCase.assertEquals("{\"node\": \"Script_0\", \"through\": [], \"children\": [], \"type\": \"Global\", \"isDynamic\": true, \"variables\": [{\"name\": \"v2\", \"references\": [{\"node\": \"BindingIdentifier_1\", \"accessibility\": \"Write\"}], \"declarations\": [{\"node\": \"BindingIdentifier_1\", \"kind\": \"Var\"}]}, {\"name\": \"v1\", \"references\": [], \"declarations\": [{\"node\": \"BindingIdentifier_2\", \"kind\": \"Var\"}]}]}", serialized);
  }
  ...
  public void testScopeSerializer_functionExpression1() throws JsError {
    ...
    // check serialization
    TestCase.assertEquals("{\"node\": \"Script_0\", \"through\": [{\"node\": \"IdentifierExpression_1\", \"accessibility\": \"Read\"}], \"children\": [{\"node\": \"FunctionExpression_2\", \"through\": [], \"children\": [{\"node\": \"FunctionExpression_2\", \"through\": [{\"node\": \"BindingIdentifier_3\", \"accessibility\": \"Write\"}], \"children\": [], \"type\": \"Function\", \"isDynamic\": false, \"variables\": [{\"name\": \"arguments\", \"references\": [], \"declarations\": []}]}], \"type\": \"FunctionName\", \"isDynamic\": false, \"variables\": [{\"name\": \"f1\", \"references\": [{\"node\": \"BindingIdentifier_3\", \"accessibility\": \"Write\"}], \"declarations\": [{\"node\": \"BindingIdentifier_4\", \"kind\": \"FunctionName\"}]}]}], \"type\": \"Global\", \"isDynamic\": true, \"variables\": [{\"name\": \"f2\", \"references\": [{\"node\": \"BindingIdentifier_5\", \"accessibility\": \"Write\"}, {\"node\": \"IdentifierExpression_6\", \"accessibility\": \"Read\"}], \"declarations\": [{\"node\": \"BindingIdentifier_5\", \"kind\": \"Var\"}]}, {\"name\": \"f1\", \"references\": [{\"node\": \"IdentifierExpression_1\", \"accessibility\": \"Read\"}], \"declarations\": []}]}", serialized);
  }
  ...
  public void testScopeSerializer_closure1() throws JsError {
    ...
    // check serialization
    TestCase.assertEquals("{\"node\": \"Script_0\", \"through\": [{\"node\": \"IdentifierExpression_1\", \"accessibility\": \"Read\"}], \"children\": [{\"node\": \"FunctionExpression_2\", \"through\": [{\"node\": \"IdentifierExpression_1\", \"accessibility\": \"Read\"}], \"children\": [], \"type\": \"Function\", \"isDynamic\": false, \"variables\": [{\"name\": \"f1\", \"references\": [{\"node\": \"BindingIdentifier_3\", \"accessibility\": \"Write\"}, {\"node\": \"IdentifierExpression_4\", \"accessibility\": \"Read\"}], \"declarations\": [{\"node\": \"BindingIdentifier_3\", \"kind\": \"Var\"}]}, {\"name\": \"arguments\", \"references\": [], \"declarations\": []}]}], \"type\": \"Global\", \"isDynamic\": true, \"variables\": [{\"name\": \"alert\", \"references\": [{\"node\": \"IdentifierExpression_1\", \"accessibility\": \"Read\"}], \"declarations\": []}]}", serialized);
  }
}
