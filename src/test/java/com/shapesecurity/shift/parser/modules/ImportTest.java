...
public class ImportTest extends Assertions {
  ...
  public void testImport() throws JsError {
    ...
    testModule("import a, * as b from 'a'", new ImportNamespace(Maybe.just(new BindingIdentifier("a")), new BindingIdentifier("b"), "\'a\'"));

//    testModule("import a, {b} from 'c'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.nothing(), new BindingIdentifier("b"))), "\'c\'"));

    testModule("import a, {b as c} from 'c'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.just("b"), new BindingIdentifier("c"))), "\'c\'"));
    testModule("import a, {function as c} from 'c'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.just("function"), new BindingIdentifier("c"))), "\'c\'"));
    testModule("import a, {as} from 'c'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.just("as"), new BindingIdentifier("as"))), "\'c\'"));
    testModule("import a, {as as c} from 'c'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.just("as"), new BindingIdentifier("c"))), "\'c\'"));
    testModule("import {as as as} from 'as'", new Import(Maybe.nothing(), ImmutableList.list(new ImportSpecifier(Maybe.just("as"), new BindingIdentifier("as"))), "\'as\'"));

//    testModule("import a, {b,} from 'c'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.nothing(), new BindingIdentifier("b"))), "\'c\'"));
//    testModule("import a, {b,c} from 'd'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.nothing(), new BindingIdentifier("b")), new ImportSpecifier(Maybe.nothing(), new BindingIdentifier("c"))), "\'d\'"));
//    testModule("import a, {b,c,} from 'd'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.list(new ImportSpecifier(Maybe.nothing(), new BindingIdentifier("b")), new ImportSpecifier(Maybe.nothing(), new BindingIdentifier("c"))), "\'d\'"));
