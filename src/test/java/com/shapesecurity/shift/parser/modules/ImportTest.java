...
public class ImportTest extends ParserTestCase {
  ...
  public void testImport() throws JsError {
    ...
    testModule("import a, {} from 'c'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.nil(),
        "\'c\'"));

    testModule("import a, {} from 'a'", new Import(Maybe.just(new BindingIdentifier("a")), ImmutableList.nil(),
        "\'a\'"));
