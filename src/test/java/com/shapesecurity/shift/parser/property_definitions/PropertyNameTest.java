...
public class PropertyNameTest extends ParserTestCase {
    ...
    public void testPropertyName() throws JsError {
        ...
        testScript("({set c(x) {}})", new ObjectExpression(ImmutableList.list(new Setter(new Parameter(new BindingIdentifier("x"), Maybe.nothing()), new FunctionBody(ImmutableList.nil(), ImmutableList.nil()), new StaticPropertyName("c")))));
        ...
        testScript("({set __proto__(x) {}})", new ObjectExpression(ImmutableList.list(new Setter(new Parameter(new BindingIdentifier("x"), Maybe.nothing()), new FunctionBody(ImmutableList.nil(), ImmutableList.nil()), new StaticPropertyName("__proto__")))));
        testScript("({get __proto__() {}, set __proto__(x) {}})", new ObjectExpression(ImmutableList.list(new Getter(new FunctionBody(ImmutableList.nil(), ImmutableList.nil()), new StaticPropertyName("__proto__")), new Setter(new Parameter(new BindingIdentifier("x"), Maybe.nothing()), new FunctionBody(ImmutableList.nil(), ImmutableList.nil()), new StaticPropertyName("__proto__")))));
