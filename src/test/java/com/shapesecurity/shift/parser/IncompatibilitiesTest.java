...
public class IncompatibilitiesTest extends Assertions {
  ...
  public void testES5Divergences() throws JsError {
    ...
    testScript("let[a] = b", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("const[a] = b", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("{ function f() {} }", new Script(ImmutableList.nil(), ImmutableList.list(
  ...
  public void testES6BackwardIncompatibilities() throws JsError {
    ...
    testScript("var yield = function yield(){};", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("try {} catch(e) { var e = 0; }", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("for(var x in [1,2]) 0", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("for(let x in [1,2]) 0", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("for(var x of [1,2]) 0", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("for(let x of [1,2]) 0", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testScript("a<!--b", new Script(ImmutableList.nil(), ImmutableList.list(
    ...
    testModule("a<!--b", new Module(ImmutableList.nil(), ImmutableList.list(new ExpressionStatement(
