...
public class EarlyErrorsTest extends ParserTestCase {
    ...
    public void testEarlyErrors() throws JsError { // TODO these should also have indices
        ...
        testScriptEarlyError("function a([yield]){ 'use strict'; }", "The identifier \"yield\" must not be in binding position in strict mode");
        testScriptEarlyError("function a({yield}){ 'use strict'; }", "The identifier \"yield\" must not be in binding position in strict mode");
        testScriptEarlyError("function a({yield=0}){ 'use strict'; }", "The identifier \"yield\" must not be in binding position in strict mode");
        testScriptEarlyError("function a({a:yield}){ 'use strict'; }", "The identifier \"yield\" must not be in binding position in strict mode");
        testScriptEarlyError("function a([yield,...a]){ 'use strict'; }", "The identifier \"yield\" must not be in binding position in strict mode");
        ...
        testScriptEarlyError("(package) => {'use strict'}", "The identifier \"package\" must not be in binding position in strict mode");
        testScriptEarlyError("([let]) => {'use strict'}", "The identifier \"let\" must not be in binding position in strict mode");
        testScriptEarlyError("({a(yield){ 'use strict'; }})", "The identifier \"yield\" must not be in binding position in strict mode");
        ...
        testScriptEarlyError("class A { *constructor(){} }", "Constructors cannot be generators, getters or setters");
        testScriptEarlyError("class A { get constructor(){} }", "Constructors cannot be generators, getters or setters");
        testScriptEarlyError("class A { set constructor(a) {} }", "Constructors cannot be generators, getters or setters");
        // It is a Syntax Error if HasDirectSuper of MethodDefinition is true.
