...
//    testScriptFailure("(a,...a)\n", 0, "Illegal newline after arrow parameters");
//    testScriptFailure("(a,...a)/*\r\n*/ => 0", 0, "Illegal newline after arrow parameters");
//    testScriptFailure("(a,...a)/*\u2028*/ => 0", 0, "Illegal newline after arrow parameters");
//    testScriptFailure("(a,...a)/*\u2029*/ => 0", 0, "Illegal newline after arrow parameters");
//    testScriptFailure("(a,...a)/*\n*/ => 0", 0, "Illegal newline after arrow parameters");
//    testScriptFailure("(a,...a)/*\r*/ => 0", 0, "Illegal newline after arrow parameters");
