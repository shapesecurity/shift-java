...
public class ArrowExpressionTest extends ParserTestCase {
    ...
    public void testArrowExpression() throws JsError {
        ...
        testScript("(a,b) => 0 + 1", new ArrowExpression(new FormalParameters(ImmutableList.list(new BindingIdentifier("a"), new BindingIdentifier("b")), Maybe.nothing()), new BinaryExpression(new LiteralNumericExpression(0.0), BinaryOperator.Plus, new LiteralNumericExpression(1.0))));
        testScript("(a,b,...c) => 0 + 1", new ArrowExpression(new FormalParameters(ImmutableList.list(new BindingIdentifier("a"), new BindingIdentifier("b")), Maybe.just(new BindingIdentifier("c"))), new BinaryExpression(new LiteralNumericExpression(0.0), BinaryOperator.Plus, new LiteralNumericExpression(1.0))));
        ...
        testScript("yield => 0", new ArrowExpression(new FormalParameters(ImmutableList.list(new BindingIdentifier("yield")), Maybe.nothing()), new LiteralNumericExpression(0.0)));
        testScript("let => 0", new ArrowExpression(new FormalParameters(ImmutableList.list(new BindingIdentifier("let")), Maybe.nothing()), new LiteralNumericExpression(0.0)));
