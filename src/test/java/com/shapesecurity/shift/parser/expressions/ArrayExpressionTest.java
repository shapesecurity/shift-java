...
public class ArrayExpressionTest extends ParserTestCase {
    ...
    public void testArrayExpression() throws JsError {
        ...
        testScript("[a, ...(b=c)]", new ArrayExpression(ImmutableList.of(Maybe.of(new IdentifierExpression("a")), Maybe.of(new SpreadElement(new AssignmentExpression(new BindingIdentifier("b"), new IdentifierExpression("c")))))));
