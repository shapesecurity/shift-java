  ...
  public void testWhitespace() throws JsError {
    ...
    testScript("{ var x = 14, y = 3\nz; }", new BlockStatement(new Block(ImmutableList.list(
        new VariableDeclarationStatement(new VariableDeclaration(VariableDeclarationKind.Var, ImmutableList.list(
            new VariableDeclarator(new BindingIdentifier("x"), Maybe.just(new LiteralNumericExpression(14.0))),
            new VariableDeclarator(new BindingIdentifier("y"), Maybe.just(new LiteralNumericExpression(3.0)))))),
    ...
    testScript("while (true) { continue\nthere; }", new WhileStatement(new LiteralBooleanExpression(true),
        new BlockStatement(new Block(ImmutableList.list(new ContinueStatement(Maybe.nothing()), new ExpressionStatement(
    ...
    testScript("while (true) { continue /* Multiline\nComment */there; }", new WhileStatement(
        ...
        Maybe.nothing()), new ExpressionStatement(new IdentifierExpression("there")))))));

    testScript("while (true) { break\nthere; }", new WhileStatement(new LiteralBooleanExpression(true),
        new BlockStatement(new Block(ImmutableList.list(new BreakStatement(Maybe.nothing()), new ExpressionStatement(
            new IdentifierExpression("there")))))));
    ...
    testScript("new\u0020\u0009\u000B\u000C\u00A0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\uFEFFa",
        new NewExpression(new IdentifierExpression("a"), ImmutableList.nil()));

    testScript("{0\n1\r2\u20283\u20294}", new BlockStatement(new Block(ImmutableList.list(new ExpressionStatement(
...
//    testScriptFailure("throw /* \n */ e", 0, "Illegal newline after throw");
