...
public class SemicolonsTest extends ParserTestCase {
    ...
    public void testStatements() throws JsError {
        testScript("function f() { return\n; }", new FunctionDeclaration(false, new BindingIdentifier("f"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
    ...
    public void testImportExport() throws JsError {
        ...
        testModule("export function f(){}\n;", new Module(
                ImmutableList.empty(),
                ImmutableList.of(
                        new Export(new FunctionDeclaration(false, new BindingIdentifier("f"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
