...
public class DirectiveTest extends ParserTestCase {
    ...
    public void testDirective() throws JsError {
        ...
        testScript("(function () { 'use\\x20strict'; with (i); })", new FunctionExpression(false, Maybe.empty(), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false), new FunctionBody(ImmutableList.of(new Directive("use\\x20strict")), ImmutableList.of(new WithStatement(new IdentifierExpression("i"), new EmptyStatement())))));
        testScript("(function () { 'use\\nstrict'; with (i); })", new FunctionExpression(false, Maybe.empty(), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false), new FunctionBody(ImmutableList.of(new Directive("use\\nstrict")), ImmutableList.of(new WithStatement(new IdentifierExpression("i"), new EmptyStatement())))));
        testScript("function a() {'use strict';return 0;};", new FunctionDeclaration(false, new BindingIdentifier("a"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false), new FunctionBody(ImmutableList.of(new Directive("use strict")), ImmutableList.of(new ReturnStatement(Maybe.of(new LiteralNumericExpression(0.0)))))));
        testScript("(function() {'use strict';return 0;});", new FunctionExpression(false, Maybe.empty(), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false), new FunctionBody(ImmutableList.of(new Directive("use strict")), ImmutableList.of(new ReturnStatement(Maybe.of(new LiteralNumericExpression(0.0)))))));
        testScript("(function a() {'use strict';return 0;});", new FunctionExpression(false, Maybe.of(new BindingIdentifier("a")), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false), new FunctionBody(ImmutableList.of(new Directive("use strict")), ImmutableList.of(new ReturnStatement(Maybe.of(new LiteralNumericExpression(0.0)))))));
