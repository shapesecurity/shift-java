package com.shapesecurity.shift.es2016.parser.destructuring.assignment;
...
public class ObjectAssignmentTargetTest extends ParserTestCase {
    ...
    public void testObjectAssignmentTarget() throws JsError {
        ...
        testScript("(function*() { [...{ x = yield }] = 0; })", new FunctionExpression(true, Maybe.empty(), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false), new FunctionBody(ImmutableList.empty(),
                ImmutableList.of(
