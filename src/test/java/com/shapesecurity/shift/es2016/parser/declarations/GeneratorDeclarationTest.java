...
public class GeneratorDeclarationTest extends ParserTestCase {
    ...
    public void testGeneratorDeclarationTest() throws JsError {
        ...
        testScript("function* hello() { yield yield z(); }", new FunctionDeclaration(false, true, new BindingIdentifier("hello"),
        ...
        testScript("function* hello() { yield* z(); }", new FunctionDeclaration(false, true, new BindingIdentifier("hello"),
                new FormalParameters(ImmutableList.empty(), Maybe.empty()), new FunctionBody(ImmutableList.empty(),
        ...
        testScript("function* a() { function a() {} function* a() {} }", new FunctionDeclaration(false, true, new BindingIdentifier("a"),
                new FormalParameters(ImmutableList.empty(), Maybe.empty()), new FunctionBody(ImmutableList.empty(),
                ImmutableList.of(new FunctionDeclaration(false, false, new BindingIdentifier("a"), new FormalParameters(
                                ImmutableList.empty(), Maybe.empty()), new FunctionBody(ImmutableList.empty(), ImmutableList.empty())),
                        new FunctionDeclaration(false, true, new BindingIdentifier("a"), new FormalParameters(ImmutableList.empty(),
