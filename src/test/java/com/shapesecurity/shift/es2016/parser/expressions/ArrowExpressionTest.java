...
//        testScript("(async ()=>0)", new ArrowExpression(true, new FormalParameters(ImmutableList.empty(), Maybe.empty()), new LiteralNumericExpression(0.0)));
        testScript("(async ()=> await 0)", new ArrowExpression(true, new FormalParameters(ImmutableList.empty(), Maybe.empty()), new LiteralNumericExpression(0.0)));
//        testScript("() => 0", new ArrowExpression(false, new FormalParameters(ImmutableList.empty(), Maybe.empty()), new LiteralNumericExpression(0.0)));
...
//        testScript("await => 0", new ArrowExpression(false, new FormalParameters(ImmutableList.of(new BindingIdentifier("await")), Maybe.empty()), new LiteralNumericExpression(0.0)));
