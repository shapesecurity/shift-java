...
public class ArrowExpressionTest extends ParserTestCase {
    ...
    public void testArrowExpression() throws JsError {
        ...
        testScript("() => 0, 1", new BinaryExpression(new ArrowExpression(new FormalParameters(ImmutableList.empty(), Maybe.empty()), new LiteralNumericExpression(0.0)), BinaryOperator.Sequence, new LiteralNumericExpression(1.0)));
        testScript("() => 0 + 1", new ArrowExpression(new FormalParameters(ImmutableList.empty(), Maybe.empty()), new BinaryExpression(new LiteralNumericExpression(0.0), BinaryOperator.Plus, new LiteralNumericExpression(1.0))));
        testScript("(a,b) => 0 + 1", new ArrowExpression(new FormalParameters(ImmutableList.of(new BindingIdentifier("a"), new BindingIdentifier("b")), Maybe.empty()), new BinaryExpression(new LiteralNumericExpression(0.0), BinaryOperator.Plus, new LiteralNumericExpression(1.0))));
        testScript("(a,b,...c) => 0 + 1", new ArrowExpression(new FormalParameters(ImmutableList.of(new BindingIdentifier("a"), new BindingIdentifier("b")), Maybe.of(new BindingIdentifier("c"))), new BinaryExpression(new LiteralNumericExpression(0.0), BinaryOperator.Plus, new LiteralNumericExpression(1.0))));
        testScript("() => (a) = 0", new ArrowExpression(new FormalParameters(ImmutableList.empty(), Maybe.empty()), new AssignmentExpression(new AssignmentTargetIdentifier("a"), new LiteralNumericExpression(0.0))));
        ...
        testScript("await => 0", new ArrowExpression(new FormalParameters(ImmutableList.of(new BindingIdentifier("await")), Maybe.empty()), new LiteralNumericExpression(0.0)));
