...
public class ClassExpressionTest extends ParserTestCase {
    ...
    public void testClassExpression() throws JsError {
        ...
        testScript("(class {;;;\n;a(){}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new StaticPropertyName("a"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))))));

        testScript("(class {;;;\n;a(){}b(){}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new StaticPropertyName("a"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))),
                new ClassElement(false, new Method(false, new StaticPropertyName("b"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))))));
        ...
        testScript("(class {a(b) {'use strict';}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new StaticPropertyName("a"), new FormalParameters(ImmutableList.of(new BindingIdentifier("b")),
                        Maybe.empty(), false), new FunctionBody(ImmutableList.of(new Directive("use strict")), ImmutableList.empty())
                        )))));

        testScript("(class {prototype() {}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new StaticPropertyName("prototype"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))))));
        ...
        testScript("(class {a(b,) {}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new StaticPropertyName("a"), new FormalParameters(ImmutableList.of(new BindingIdentifier("b")), Maybe.empty(), true),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))))));

        testScript("(class {3() {}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new StaticPropertyName("3"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))))));
        ...
        testScript("(class{[3+5](){}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new ComputedPropertyName(new BinaryExpression(
                        new LiteralNumericExpression(3.0), BinaryOperator.Plus, new LiteralNumericExpression(5.0))), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))))));
        ...
        testScript("(class {static(){}})", new ClassExpression(Maybe.empty(), Maybe.empty(), ImmutableList.of(
                new ClassElement(false, new Method(false, new StaticPropertyName("static"), new FormalParameters(ImmutableList.empty(), Maybe.empty(), false),
                        new FunctionBody(ImmutableList.empty(), ImmutableList.empty()))))));

        testScript("(class {static constructor(){}})", new ClassExpression(Maybe.empty(), Maybe.empty(),
                ImmutableList.of(new ClassElement(true, new Method(false, new StaticPropertyName("constructor"), new FormalParameters(ImmutableList.empty(),
        ...
        testScriptFailure("(class {a(,)})", 10, "Unexpected token \",\"");
        testScriptFailure("(class {a(b,,)})", 12, "Unexpected token \",\"");
        testScriptFailure("(class {a(b, ...c,)})", 17, "Unexpected token \",\"");
