...
public class ArrowExpressionTest extends ParserTestCase {
    ...
    public void testArrowExpression() throws JsError {
        ...
        testScript("a => 0", new ArrowExpression(false, new FormalParameters(ImmutableList.of(new BindingIdentifier("a")), Maybe.empty()), new LiteralNumericExpression(0.0)));
        testScript("({a}) => 0", new ArrowExpression(false, new FormalParameters(ImmutableList.of(new ObjectBinding(ImmutableList.of(new BindingPropertyIdentifier(new BindingIdentifier("a"), Maybe.empty())), Maybe.empty())), Maybe.empty()), new LiteralNumericExpression(0.0)));
        ...
        testScript("(a, {x = 0})=>0", new ArrowExpression(false, new FormalParameters(ImmutableList.of(new BindingIdentifier("a"), new ObjectBinding(ImmutableList.of(new BindingPropertyIdentifier(new BindingIdentifier("x"), Maybe.of(new LiteralNumericExpression(0.0)))), Maybe.empty())), Maybe.empty()), new LiteralNumericExpression(0.0)));
        testScript("({x = 0}, {y = 0}, {z = 0})=>0", new ArrowExpression(false, new FormalParameters(ImmutableList.of(new ObjectBinding(ImmutableList.of(new BindingPropertyIdentifier(new BindingIdentifier("x"), Maybe.of(new LiteralNumericExpression(0.0)))), Maybe.empty()), new ObjectBinding(ImmutableList.of(new BindingPropertyIdentifier(new BindingIdentifier("y"), Maybe.of(new LiteralNumericExpression(0.0)))), Maybe.empty()), new ObjectBinding(ImmutableList.of(new BindingPropertyIdentifier(new BindingIdentifier("z"), Maybe.of(new LiteralNumericExpression(0.0)))), Maybe.empty())), Maybe.empty()), new LiteralNumericExpression(0.0)));
