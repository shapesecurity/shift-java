...
public class UnitTest {
  ...
  private void assertFail(Node node) {

  }

  @Test
  public void testBindingIdentifier() {
    ImmutableList<ValidationError> errors = Validator.validate(new Script(ImmutableList.nil(), ImmutableList.list(new ExpressionStatement(new IdentifierExpression(".")))));
