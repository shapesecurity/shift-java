...
import static com.shapesecurity.laserbat.js.path.BranchType.ARGUMENTS;
import static com.shapesecurity.laserbat.js.path.BranchType.BINDING;
import static com.shapesecurity.laserbat.js.path.BranchType.BLOCK;
import static com.shapesecurity.laserbat.js.path.BranchType.BODY;
import static com.shapesecurity.laserbat.js.path.BranchType.CALLEE;
import static com.shapesecurity.laserbat.js.path.BranchType.CATCH;
import static com.shapesecurity.laserbat.js.path.BranchType.CONSEQUENT;
import static com.shapesecurity.laserbat.js.path.BranchType.DECLARATION;
import static com.shapesecurity.laserbat.js.path.BranchType.DECLARATORS;
import static com.shapesecurity.laserbat.js.path.BranchType.EXPRESSION;
import static com.shapesecurity.laserbat.js.path.BranchType.IDENTIFIER;
import static com.shapesecurity.laserbat.js.path.BranchType.INIT;
import static com.shapesecurity.laserbat.js.path.BranchType.LEFT;
import static com.shapesecurity.laserbat.js.path.BranchType.NAME;
import static com.shapesecurity.laserbat.js.path.BranchType.OBJECT;
import static com.shapesecurity.laserbat.js.path.BranchType.OPERAND;
import static com.shapesecurity.laserbat.js.path.BranchType.PARAMETERS;
import static com.shapesecurity.laserbat.js.path.BranchType.RIGHT;
import static com.shapesecurity.laserbat.js.path.BranchType.STATEMENTS;
import static com.shapesecurity.laserbat.js.path.BranchType.TEST;
...
public class ScopeTest extends TestBase {
  ...
  private static class Getter {
    ...
    private Getter(@Nonnull Node node, @Nonnull List<Branch> from) {
      this.node = node;
      this.from = from;
    }
  ...
  private static void checkScope(
      ...
      @Nonnull final List<Scope> children,
      @Nonnull final List<String> through,
      @Nonnull final Map<String, Pair<List<IdentifierP>, List<IdentifierP>>> variables,
