...
package com.shapesecurity.laserbat.js.utils;
...
public final class Utils {
  ...
  public static boolean isStrictModeReservedWordES5(@Nonnull String name) {
    return STRICT_MODE_RESERVED_WORD_ES5.contains(name);
  }

  public static boolean isValidIdentifierName(@Nonnull String name) {
    if (name.isEmpty()) {
      return false;
    }
  ...
  public static boolean areUniqueNames(@Nonnull List<Identifier> list) {
  ...
  public static boolean isStrictModeReservedWordES6(@Nonnull String word) {
    switch (word) {
    case "implements":
    case "interface":
    case "package":
