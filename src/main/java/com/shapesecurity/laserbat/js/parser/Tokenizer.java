...
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNEXPECTED_EOS;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNEXPECTED_IDENTIFIER;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNEXPECTED_NUMBER;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNEXPECTED_RESERVED_WORD;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNEXPECTED_STRING;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNEXPECTED_TOKEN;

import com.shapesecurity.laserbat.js.parser.token.EOFToken;
import com.shapesecurity.laserbat.js.parser.token.FalseLiteralToken;
import com.shapesecurity.laserbat.js.parser.token.IdentifierToken;
import com.shapesecurity.laserbat.js.parser.token.KeywordToken;
import com.shapesecurity.laserbat.js.parser.token.NullLiteralToken;
import com.shapesecurity.laserbat.js.parser.token.NumericLiteralToken;
import com.shapesecurity.laserbat.js.parser.token.PunctuatorToken;
import com.shapesecurity.laserbat.js.parser.token.RegularExpressionLiteralToken;
import com.shapesecurity.laserbat.js.parser.token.StringLiteralToken;
import com.shapesecurity.laserbat.js.parser.token.TrueLiteralToken;
...
public class Tokenizer {
  protected static final HashSet<String> STRICT_MODE_RESERVED_WORD = new HashSet<>(Arrays.asList("implements",
  ...
  public Tokenizer(@Nonnull String source) throws JsError {
    this(false, source);
  }

  protected Tokenizer(boolean directed, @Nonnull String source) throws JsError {
  ...
  @Nonnull
  public static ArrayList<Token> tokenize(@Nonnull String source) throws JsError {
  ...
  protected int trackBackLineNumber(int position) {
  ...
  @Nonnull
  protected JsError createError(@Nonnull Token token, @Nonnull String message, @Nonnull Object... args) {
    String msg = String.format(message, args);
  ...
  protected void skipComment() throws JsError {
  ...
  @Nonnull
  protected Token scanRegExp() throws JsError {
