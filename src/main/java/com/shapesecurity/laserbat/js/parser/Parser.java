...
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.ACCESSOR_DATA_PROPERTY;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.ACCESSOR_GET_SET;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.ILLEGAL_BREAK;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.ILLEGAL_CONTINUE;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.ILLEGAL_RETURN;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.INVALID_LHS_IN_ASSIGNMENT;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.INVALID_LHS_IN_FOR_IN;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.INVALID_PROPERTY_NAME;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.LABEL_REDECLARATION;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.MULTIPLE_DEFAULTS_IN_SWITCH;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.NEWLINE_AFTER_THROW;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.NO_CATCH_OR_FINALLY;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_CATCH_VARIABLE;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_DELETE;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_DUPLICATE_PROPERTY;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_FUNCTION_NAME;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_LHS_ASSIGNMENT;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_LHS_POSTFIX;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_LHS_PREFIX;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_MODE_WITH;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_OCTAL_LITERAL;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_PARAM_DUPE;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_PARAM_NAME;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_RESERVED_WORD;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.STRICT_VAR_NAME;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNEXPECTED_TOKEN;
import static com.shapesecurity.laserbat.js.parser.ErrorMessages.UNKNOWN_LABEL;
...
import com.shapesecurity.laserbat.js.ast.expression.LeftHandSideExpression;
...
import com.shapesecurity.laserbat.js.ast.operators.Additive;
...
import com.shapesecurity.laserbat.js.ast.operators.Equality;
...
import com.shapesecurity.laserbat.js.ast.operators.Shift;
...
import com.shapesecurity.laserbat.js.ast.property.ObjectProperty.ObjectPropertyKind;
...
import com.shapesecurity.laserbat.js.parser.token.IdentifierLikeToken;
import com.shapesecurity.laserbat.js.parser.token.IdentifierToken;
import com.shapesecurity.laserbat.js.parser.token.NumericLiteralToken;
import com.shapesecurity.laserbat.js.parser.token.StringLiteralToken;
...
public class Parser extends Tokenizer {
  ...
  private BinaryOperator lookupBinaryOperator(@Nonnull TokenType type) {
    ...
    case EQ_STRICT:
      return Equality.StrictEqual;
    case NE_STRICT:
      return Equality.StrictNotEqual;
    case LT:
      return Relational.LessThan;
    case GT:
      return Relational.GreaterThan;
    case LTE:
      return Relational.LessThanEqual;
    case GTE:
      return Relational.GreaterThanEqual;
    case INSTANCEOF:
      return Relational.Instanceof;
    case IN:
      return this.allowIn ? Relational.In : null;
    case SHL:
      return Shift.Left;
    case SHR:
      return Shift.Right;
    case SHR_UNSIGNED:
      return Shift.UnsignedRight;
    case ADD:
      return Additive.Plus;
    case SUB:
      return Additive.Minus;
    case MUL:
      return Multiplicative.Mul;
    case DIV:
      return Multiplicative.Div;
    case MOD:
      return Multiplicative.Rem;
    default:
      return null;
    }
  }
