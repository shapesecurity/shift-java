...
public interface ValidationErrorMessages {
    ...
    String ONE_VARIABLE_DECLARATOR_IN_FOR_AWAIT = "VariableDeclaration in ForAwaitStatement can only have one VariableDeclarator";
    String NO_INIT_IN_VARIABLE_DECLARATOR_IN_FOR_AWAIT = "The VariableDeclarator in ForAwaitStatement should not have an initializer";
