...
import com.shapesecurity.shift.es2018.scope.Declaration.Kind;
import com.shapesecurity.shift.es2018.scope.ScopeAnalyzer.State;
...
public final class ScopeAnalyzer extends MonoidalReducer<State> {
    ...
    @Nonnull
    @Override
    public State reduceForAwaitStatement(@Nonnull ForAwaitStatement node, @Nonnull State left, @Nonnull State right, @Nonnull State body) {
        return super.reduceForAwaitStatement(node, left.addReferences(Accessibility.Write), right, body).finish(node, Scope.Type.Block);
    }
