...
public class Scope {
	...
	@NotNull
	protected List<Variable> findVariables(
		@NotNull
	...
	@NotNull
	private List<Variable> findVariablesHelper(@NotNull final Identifier identifier, boolean lookInReferences, boolean lookInDeclarations) {
