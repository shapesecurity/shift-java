...
public class ForInStatement extends IterationStatement {
  ...
  @Nonnull
  public ForInStatement setLeft(@Nonnull Either<VariableDeclaration, Expression> left) {
    return new ForInStatement(left, right, body);
  }

  @Nonnull
  public ForInStatement setRight(@Nonnull Expression right) {
    return new ForInStatement(left, right, body);
  }
  @Nonnull
  public ForInStatement setBody(@Nonnull Statement body) {
    return new ForInStatement(left, right, body);
  }
}
