...
public class Flattener extends MonoidalReducer<ImmutableList<Node>> {
    ...
    @Nonnull
    @Override
    public ImmutableList<Node> reduceAwaitExpression(@Nonnull AwaitExpression node, @Nonnull ImmutableList<Node> expression) {
        return ImmutableList.<Node>of(node).append(super.reduceAwaitExpression(node, expression));
    }
