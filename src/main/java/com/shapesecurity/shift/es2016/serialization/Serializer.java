...
public class Serializer implements Reducer<StringBuilder> {
    ...
    private static class JsonObjectBuilder {
        ...
        JsonObjectBuilder add(@Nonnull String property, boolean value) {
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(value);
            return this;
        }
        ...
        JsonObjectBuilder add(@Nonnull String property, @Nonnull String value) {
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(JSONObject.quote(value));
            return this;
        }
        ...
        JsonObjectBuilder add(@Nonnull String property, @Nonnull BinaryOperator value) {
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(JSONObject.quote(value.getName()));
            return this;
        }
        ...
        JsonObjectBuilder add(@Nonnull String property, @Nonnull VariableDeclarationKind value) {
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(JSONObject.quote(value.name));
            return this;
        }
        ...
        JsonObjectBuilder addMaybeString(@Nonnull String property, @Nonnull Maybe<String> value) {
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(value.map(Utils::escapeStringLiteral).orJust("null"));
            return this;
        }
        ...
        JsonObjectBuilder add(@Nonnull String property, @Nonnull Maybe<StringBuilder> value) {
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(o(value));
            return this;
        }
        ...
        JsonObjectBuilder add(@Nonnull String property, @Nonnull ImmutableList<StringBuilder> value) {
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(list(value));
            return this;
        }
        ...
        JsonObjectBuilder addListMaybe(@Nonnull String property, @Nonnull ImmutableList<Maybe<StringBuilder>> value) { // because type erasure
            optionalComma();
            this.text.append(JSONObject.quote(property)).append(":").append(list(value.map(Serializer::o)));
            return this;
        }
