            ...
            if (jsonObject.has("type")) {
                ...
                switch (nodeType) {
                    ...
                    case "ForAwaitStatement":
                        return new ForAwaitStatement((VariableDeclarationAssignmentTarget) deserializeNode(jsonObject.get("left")), (Expression) deserializeNode(jsonObject.get("right")), (Statement) deserializeNode(jsonObject.get("body")));
                    case "ForInStatement":
                    ...
                    case "LiteralRegExpExpression":
                        return new LiteralRegExpExpression(jsonObject.get("pattern").getAsString(), jsonObject.get("global").getAsBoolean(), jsonObject.get("ignoreCase").getAsBoolean(), jsonObject.get("multiLine").getAsBoolean(), jsonObject.get("dotAll").getAsBoolean(), jsonObject.get("unicode").getAsBoolean(), jsonObject.get("sticky").getAsBoolean());
                    ...
                    case "ObjectAssignmentTarget":
                        return new ObjectAssignmentTarget(deserializeListAssignmentTargetProperty(jsonObject.get("properties")), deserializeMaybeAssignmentTarget(jsonObject.get("rest")));
                    case "ObjectBinding":
                        return new ObjectBinding(deserializeListBindingProperty(jsonObject.get("properties")), deserializeMaybeBinding(jsonObject.get("rest")));
