...
public class Serializer implements Reducer<StringBuilder> {
    ...
    @Nonnull
    @Override
    public StringBuilder reduceForAwaitStatement(@Nonnull ForAwaitStatement node, @Nonnull StringBuilder left, @Nonnull StringBuilder right, @Nonnull StringBuilder body) {
        return b("ForAwaitStatement").add("left", left).add("right", right).add("body", body).done();
    }
    ...
    public StringBuilder reduceLiteralRegExpExpression(@Nonnull LiteralRegExpExpression node) {
        return b("LiteralRegExpExpression").add("pattern", node.pattern).add("global", node.global).add("ignoreCase", node.ignoreCase).add("multiLine", node.multiLine).add("dotAll", node.dotAll).add("unicode", node.unicode).add("sticky", node.sticky).done();
    }
    ...
    @Nonnull
    @Override
    public StringBuilder reduceObjectAssignmentTarget(@Nonnull ObjectAssignmentTarget node, @Nonnull ImmutableList<StringBuilder> properties, @Nonnull Maybe<StringBuilder> rest) {
        return b("ObjectAssignmentTarget").add("properties", properties).add("rest", rest).done();
    }

    @Nonnull
    @Override
    public StringBuilder reduceObjectBinding(@Nonnull ObjectBinding node, @Nonnull ImmutableList<StringBuilder> properties, @Nonnull Maybe<StringBuilder> rest) {
        return b("ObjectBinding").add("properties", properties).add("rest", rest).done();
    }
