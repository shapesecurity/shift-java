...
public abstract class Branch {
	...
	public static ForAwaitStatementLeft ForAwaitStatementLeft_() {
		return new ForAwaitStatementLeft();
	}

	public static ForAwaitStatementRight ForAwaitStatementRight_() {
		return new ForAwaitStatementRight();
	}

	public static ForAwaitStatementBody ForAwaitStatementBody_() {
		return new ForAwaitStatementBody();
	}
	...
	public static ObjectAssignmentTargetRest ObjectAssignmentTargetRest_() {
		return new ObjectAssignmentTargetRest();
	}
	...
	public static ObjectBindingRest ObjectBindingRest_() {
		return new ObjectBindingRest();
	}
...
class ForAwaitStatementLeft extends Branch {
	@Override
	public Maybe<? extends Node> step(Node node) {
		if (!(node instanceof ForAwaitStatement)) return Maybe.empty();
		return Maybe.of(((ForAwaitStatement) node).left);
	}
...
class ForAwaitStatementRight extends Branch {
	@Override
	public Maybe<? extends Node> step(Node node) {
		if (!(node instanceof ForAwaitStatement)) return Maybe.empty();
		return Maybe.of(((ForAwaitStatement) node).right);
	}
...
class ForAwaitStatementBody extends Branch {
	@Override
	public Maybe<? extends Node> step(Node node) {
		if (!(node instanceof ForAwaitStatement)) return Maybe.empty();
		return Maybe.of(((ForAwaitStatement) node).body);
	}
...
class ObjectAssignmentTargetRest extends Branch {
	@Override
	public Maybe<? extends Node> step(Node node) {
		if (!(node instanceof ObjectAssignmentTarget)) return Maybe.empty();
		return ((ObjectAssignmentTarget) node).rest;
	}
...
class ObjectBindingRest extends Branch {
	@Override
	public Maybe<? extends Node> step(Node node) {
		if (!(node instanceof ObjectBinding)) return Maybe.empty();
		return ((ObjectBinding) node).rest;
	}
