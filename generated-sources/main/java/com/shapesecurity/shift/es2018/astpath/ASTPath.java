...
public abstract class ASTPath<S, T> extends ObjectPath<S, T> {
  ...
  public static class BinaryExpression_Operator extends ASTPath.TrivialPath<BinaryExpression, com.shapesecurity.shift.es2018.ast.operators.BinaryOperator> {
    @Override
    Maybe<com.shapesecurity.shift.es2018.ast.operators.BinaryOperator> apply(Object source) {
      if (!(source instanceof BinaryExpression)) return Maybe.empty();
  ...
  public static class CompoundAssignmentExpression_Operator extends ASTPath.TrivialPath<CompoundAssignmentExpression, com.shapesecurity.shift.es2018.ast.operators.CompoundAssignmentOperator> {
    @Override
    Maybe<com.shapesecurity.shift.es2018.ast.operators.CompoundAssignmentOperator> apply(Object source) {
      if (!(source instanceof CompoundAssignmentExpression)) return Maybe.empty();
  ...
  public static class ForAwaitStatement_Left extends ASTPath.TrivialPath<ForAwaitStatement, VariableDeclarationAssignmentTarget> {
    @Override
  ...
  public static class ForAwaitStatement_Right extends ASTPath.TrivialPath<ForAwaitStatement, Expression> {
    @Override
    Maybe<Expression> apply(Object source) {
      if (!(source instanceof ForAwaitStatement)) return Maybe.empty();
  ...
  public static class ForAwaitStatement_Body extends ASTPath.TrivialPath<ForAwaitStatement, Statement> {
    @Override
    Maybe<Statement> apply(Object source) {
      if (!(source instanceof ForAwaitStatement)) return Maybe.empty();
  ...
  public static class LiteralRegExpExpression_DotAll extends ASTPath.TrivialPath<LiteralRegExpExpression, Boolean> {
    @Override
    Maybe<Boolean> apply(Object source) {
      if (!(source instanceof LiteralRegExpExpression)) return Maybe.empty();
  ...
  public static class ObjectAssignmentTarget_Rest extends ASTPath.TrivialPath<ObjectAssignmentTarget, AssignmentTarget> {
    @Override
    Maybe<AssignmentTarget> apply(Object source) {
      if (!(source instanceof ObjectAssignmentTarget)) return Maybe.empty();
      return ((ObjectAssignmentTarget) source).rest;
    }
  ...
  public static class ObjectBinding_Rest extends ASTPath.TrivialPath<ObjectBinding, Binding> {
    @Override
    Maybe<Binding> apply(Object source) {
      if (!(source instanceof ObjectBinding)) return Maybe.empty();
      return ((ObjectBinding) source).rest;
    }
  ...
  public static class UnaryExpression_Operator extends ASTPath.TrivialPath<UnaryExpression, com.shapesecurity.shift.es2018.ast.operators.UnaryOperator> {
    @Override
    Maybe<com.shapesecurity.shift.es2018.ast.operators.UnaryOperator> apply(Object source) {
  ...
  public static class UpdateExpression_Operator extends ASTPath.TrivialPath<UpdateExpression, com.shapesecurity.shift.es2018.ast.operators.UpdateOperator> {
    @Override
    Maybe<com.shapesecurity.shift.es2018.ast.operators.UpdateOperator> apply(Object source) {
      if (!(source instanceof UpdateExpression)) return Maybe.empty();
