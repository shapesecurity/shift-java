...
public class WrappedReducer<T> implements Reducer<T> {
  ...
  public WrappedReducer(@Nonnull F2<Node, T, T> wrap, @Nonnull Reducer<T> reducer) {
    ...
    @Nonnull
    @Override
    public T reduceForAwaitStatement(@Nonnull ForAwaitStatement node, @Nonnull T left, @Nonnull T right, @Nonnull T body) {
        return wrap.apply(node, reducer.reduceForAwaitStatement(node, left, right, body));
    }
    ...
    @Nonnull
    @Override
    public T reduceObjectAssignmentTarget(@Nonnull ObjectAssignmentTarget node, @Nonnull ImmutableList<T> properties, @Nonnull Maybe<T> rest) {
        return wrap.apply(node, reducer.reduceObjectAssignmentTarget(node, properties, rest));
    }

    @Nonnull
    @Override
    public T reduceObjectBinding(@Nonnull ObjectBinding node, @Nonnull ImmutableList<T> properties, @Nonnull Maybe<T> rest) {
        return wrap.apply(node, reducer.reduceObjectBinding(node, properties, rest));
    }
