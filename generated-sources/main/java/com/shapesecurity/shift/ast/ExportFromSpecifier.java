...
public class ExportFromSpecifier implements Node {
  ...
  @NotNull
  public ExportFromSpecifier setName(@NotNull String name)
  {
    return new ExportFromSpecifier(name, this.exportedName);
  }

  @NotNull
  public ExportFromSpecifier setExportedName(@NotNull Maybe<String> exportedName)
  {
    return new ExportFromSpecifier(this.name, exportedName);
  }
