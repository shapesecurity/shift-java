...
public class VariableDeclaration extends Node implements FunctionDeclarationClassDeclarationVariableDeclaration, VariableDeclarationBinding, VariableDeclarationExpression
{
  ...
  public VariableDeclaration (@NotNull SourceSpan loc, @NotNull VariableDeclarationKind kind, @NotNull ImmutableList<VariableDeclarator> declarators)
  {
    super(loc);
    this.kind = kind;
