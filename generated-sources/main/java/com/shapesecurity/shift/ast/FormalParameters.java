...
public class FormalParameters extends Node
{
  ...
  public FormalParameters (@NotNull SourceSpan loc, @NotNull ImmutableList<BindingBindingWithDefault> items, @NotNull Maybe<BindingIdentifier> rest)
  {
    super(loc);
    this.items = items;
    this.rest = rest;
  ...
  public FormalParameters (@NotNull ImmutableList<BindingBindingWithDefault> items, @NotNull Maybe<BindingIdentifier> rest)
  {
    super();
    this.items = items;
    this.rest = rest;
