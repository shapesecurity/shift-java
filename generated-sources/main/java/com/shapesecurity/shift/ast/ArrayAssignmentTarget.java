...
public class ArrayAssignmentTarget implements Node, AssignmentTargetPattern {
  ...
  @NotNull
  public ImmutableList<Maybe<AssignmentTargetAssignmentTargetWithDefault>> getElements()
  {
    return this.elements;
  }

  @NotNull
  public Maybe<AssignmentTarget> getRest()
  {
    return this.rest;
  }

  @NotNull
  public ArrayAssignmentTarget setElements(@NotNull ImmutableList<Maybe<AssignmentTargetAssignmentTargetWithDefault>> elements)
  {
    return new ArrayAssignmentTarget(elements, this.rest);
  }

  @NotNull
  public ArrayAssignmentTarget setRest(@NotNull Maybe<AssignmentTarget> rest)
  {
    return new ArrayAssignmentTarget(this.elements, rest);
  }
