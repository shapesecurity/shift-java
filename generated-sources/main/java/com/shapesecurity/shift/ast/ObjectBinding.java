...
public class ObjectBinding extends Node implements Binding
{

  @NotNull
  public final ImmutableList<BindingProperty> properties;

  public ObjectBinding (@NotNull SourceSpan loc, @NotNull ImmutableList<BindingProperty> properties)
  {
    super(loc);
