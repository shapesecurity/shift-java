...
public abstract class ImportDeclaration extends Node implements ImportDeclarationExportDeclarationStatement
{

  @NotNull
  public final String  moduleSpecifier;

  public ImportDeclaration (@NotNull SourceSpan loc, @NotNull String  moduleSpecifier)
  {
    super(loc);
