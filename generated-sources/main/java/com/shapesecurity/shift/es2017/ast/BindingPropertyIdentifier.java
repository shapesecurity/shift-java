...
public class BindingPropertyIdentifier implements BindingProperty {
    @Nonnull
    ...
    public BindingPropertyIdentifier (@Nonnull BindingIdentifier binding, @Nonnull Maybe<Expression> init) {
